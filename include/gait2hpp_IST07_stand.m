...
% SURF4 ---------------------------------------
    ...
    % percent pattern
    fprintf(fid, ['\r\n// Percent Pattern\r\n']);
    fprintf(fid, ['const uint16_t gait_stand_SURF4' '_PP[' num2str(num_channels) '][8] = { \r\n']);
    for channel_id = 1:num_channels
        fprintf(fid, '\t\t');
    ...
    % Print Pulse width
    fprintf(fid, ['\r\n// Pulse Width\r\n']);
    fprintf(fid, ['const uint8_t gait_stand_SURF4' '_PW[' num2str(num_channels) '][8] = { \r\n']);
    for channel_id = 1:num_channels
        fprintf(fid, '\t\t');
    ...
    % Print Inter Phase Interval
    fprintf(fid, ['\r\n// Inter Phase Interval\r\n']);
    fprintf(fid, ['const uint8_t gait_stand_SURF4' '_IPI[' num2str(num_channels) '] = \r\n']);
    fprintf(fid, '\t\t{ ');
    for channel_id = 1:num_channels
