...
% Step duration
fprintf(fid, ['\r\n// Step Duration \r\n']);
fprintf(fid, ['const float gait_stand_duration PROGMEM = ' num2str(gait.Stand.duration) '; \r\n']);
...
% Left Step
    ...
    % percent pattern
    fprintf(fid, ['\r\n// Percent Pattern\r\n']);
    fprintf(fid, ['const uint16_t gait_stand_B' num2str(board_id) '_PP[12][8] PROGMEM = { \r\n']);
    for channel_id = 1:12
        fprintf(fid, '\t\t');
    ...
    % Print Pulse width
    fprintf(fid, ['\r\n// Pulse Width\r\n']);
    fprintf(fid, ['const uint8_t gait_stand_B' num2str(board_id) '_PW[12][8] PROGMEM = { \r\n']);
    for channel_id = 1:12
        fprintf(fid, '\t\t');
    ...
    fprintf(fid, ['const uint8_t gait_stand_B' num2str(board_id) '_IPI[12] PROGMEM = \r\n']);
    fprintf(fid, '\t\t{ ');
    for channel_id = 1:12
